...
$data = [
    ...
    "image"             => "https://i.pinimg.com/originals/5f/04/be/5f04be8910647ca0fe4797b79a3ec67c.png",
    "prefill"           => [
    "name"              => $name,
    "email"             => $email,
    "contact"           => $mobile,
...
<form action="verify.php" method="POST">
  <script
    ...
    data-notes.shopping_order_id="<?php echo 'OID'.rand(100,10000);?>"
...
<head>
    ...
    <title>Selfieera Ads Dashboard</title>
...
<body>
    <div class="flex h-screen bg-gray-50 dark:bg-gray-900" :class="{ 'overflow-hidden': isSideMenuOpen }"><aside class="z-20 hidden w-64 overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0">
   <div class="left-panel py-4 text-gray-500 dark:text-gray-400">
      <a class="ml-6 text-lg font-bold text-gray-800 dark:text-gray-200" href="#">
         Username
      </a>
      <ul class="mt-6">
         <li class="relative px-6 py-3">
            <span class="" aria-hidden="true" url="dashboard.php"></span>
      ...
      <ul>
         <li class="relative px-6 py-3">
             <span class="" aria-hidden="true" url="create-ad.php"></span>
            <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200" href="create-ad.php">
               <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                  <path d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path>
               </svg>
               <span class="ml-4">Create Campaign</span>
            </a>
         </li>
         <li class="relative px-6 py-3">
             <span class="" aria-hidden="true" url="payment.php"></span>
            <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200" href="payment.php">
               ...
               <span class="ml-4">Add Payment</span>
            </a>
         </li>
           <!--  <li class="relative px-6 py-3">
              <a
...
<aside class="left-panel fixed inset-y-0 z-20 flex-shrink-0 w-64 mt-16 overflow-y-auto bg-white dark:bg-gray-800 md:hidden" x-show="isSideMenuOpen" x-transition:enter="transition ease-in-out duration-150" x-transition:enter-start="opacity-0 transform -translate-x-20" x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in-out duration-150" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0 transform -translate-x-20" @click.away="closeSideMenu" @keydown.escape="closeSideMenu">
   <div class="py-4 text-gray-500 dark:text-gray-400">
      ...
      <div class="px-6 my-6">
                    ...
                    <ul class="flex items-center flex-shrink-0 space-x-6">
                        ...
                        <li class="relative">
                            <button class="align-middle rounded-full focus:shadow-outline-purple focus:outline-none" @click="toggleProfileMenu" @keydown.escape="closeProfileMenu" aria-label="Account" aria-haspopup="true">
                                <img class="object-cover w-8 h-8 rounded-full" src="https://selfieera.com/img/48%20(1).png" alt="" aria-hidden="true" />
                            </button>
            ...
            </header><main class="h-full pb-16 overflow-y-auto">
	<div class="container px-6 mx-auto grid">
		...
		<div class="px-4 py-3 mb-8  rounded-lg shadow-md dark:bg-gray-800" style="background-color:#38f9d7"">
			<form method="POST" id="payment-form" action="pay.php">
				...
				<label class="block mt-4 text-sm">
					...
					<input name="payment_amount" value="<?= $_SESSION['amount'] ?>" class="pay_amount block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="₹100" />
				</label>

				<div class="flex mt-6 text-sm">
					<label class="flex items-center dark:text-gray-400">
						<input name="iagree" type="checkbox" checked class="text-purple-600 form-checkbox focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray" />
						<span class="ml-2">
							I agree to the
  ...
  $(function() {
    ...
    $(".left-panel ul li span").each(function(){
      if($(this).attr("url") == pgurl || $(this).attr("url") == '' )
        $(this).attr('class', 'absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg');
    })
  });
